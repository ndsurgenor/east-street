...
:-----:|:-----:|:-----:|:-----:|-----
Initial Setup|1.1|Dev Goal|Set up Django and its supporting libraries via the IDE in order for development to begin|<ul><li>Install server: django-gunicorn</li><li>Install PostgreSQL library: dj_database_url psycopg2</li><li>Install image host: dj3-cloudinary-storage</li><li>Install sign-up/in/out functionality: django-allauth</li><li>Create requirements.txt file</li></ul>
